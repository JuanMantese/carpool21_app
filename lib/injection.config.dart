...
import 'package:carpool_21_app/src/data/dataSource/remote/services/usersService.dart'
    as _i5;
import 'package:carpool_21_app/src/di/appModule.dart' as _i30;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i9.PassengerRequestsService>(
        () => appModule.passengerRequestsService);
    gh.factory<_i10.ReserveService>(() => appModule.reserveService);
    gh.factory<_i11.Socket>(() => appModule.socket);
    gh.factory<_i12.AuthRepository>(() => appModule.authRepository);
    gh.factory<_i13.AuthUseCases>(() => appModule.authUseCases);
    gh.factory<_i14.UsersRepository>(() => appModule.usersRepository);
    gh.factory<_i15.UserUseCases>(() => appModule.userUseCases);
    gh.factory<_i16.GeolocationRepository>(
        () => appModule.geolocationRepository);
    gh.factory<_i17.GeolocationUseCases>(() => appModule.geolocationUseCases);
    gh.factory<_i18.CarInfoRepository>(() => appModule.carInfoRepository);
    gh.factory<_i19.CarInfoUseCases>(() => appModule.carInfoUseCases);
    gh.factory<_i20.DriverPositionRepository>(
        () => appModule.driverPositionRepository);
    gh.factory<_i21.DriversPositionUseCases>(
        () => appModule.driversPositionUseCases);
    gh.factory<_i22.DriverTripRequestsRepository>(
        () => appModule.driverTripRequestsRepository);
    gh.factory<_i23.DriverTripRequestsUseCases>(
        () => appModule.driverTripRequestsUseCases);
    gh.factory<_i24.PassengerRequestRepository>(
        () => appModule.passengerRequestRepository);
    gh.factory<_i25.PassengerRequestsUseCases>(
        () => appModule.passengerRequestsUseCases);
    gh.factory<_i26.ReserveRepository>(() => appModule.reserveRepository);
    gh.factory<_i27.ReserveUseCases>(() => appModule.reserveUseCases);
    gh.factory<_i28.SocketRepository>(() => appModule.socketRepository);
    gh.factory<_i29.SocketUseCases>(() => appModule.socketUseCases);
    return this;
  }
}
