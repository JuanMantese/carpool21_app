...
class TripsAvailableBloc extends Bloc<TripsAvailableEvent, TripsAvailableState> {
  ...
  TripsAvailableBloc(
    ...
    void _setTestPassengerRequests(GetNearbyTripRequest event, Emitter<TripsAvailableState> emit) {
      List<PassengerRequest> toTripsAvailable = [
        PassengerRequest(
          id: 1,
          idDriver: 101,
          idCompensation: 201,
          pickupText: "Lugar de Origen Testing - Avenida Armada Argentina 3555",
          pickupLat: 37.7749,
          pickupLng: -122.4194,
          destinationText: "Lugar de Destino Testing - Avenida Armada Argentina 3555",
          ...
          car: CarInfo(brand: "Toyota", model: "Corolla", patent: '123456', color: 'red', nroGreenCard: '1234', seats: 5, year: 2024),
        ...
        PassengerRequest(
          ...
          car: CarInfo(brand: "Honda", model: "Civic", patent: '123456', color: 'red', nroGreenCard: '1234', seats: 5, year: 2023),
          createdAt: DateTime.parse("2024-06-14T12:00:00Z"),
          updatedAt: DateTime.parse("2024-06-14T12:00:00Z"),
          fareAssigned: 25.0,
          googleDistanceMatrix: GoogleDistanceMatrix(
        ...
        PassengerRequest(
          ...
          car: CarInfo(brand: "Ford", model: "Focus", patent: '123456', color: 'red', nroGreenCard: '1234', seats: 5, year: 2025),
          createdAt: DateTime.parse("2024-06-14T12:00:00Z"),
          updatedAt: DateTime.parse("2024-06-14T12:00:00Z"),
          fareAssigned: 18.0,
          googleDistanceMatrix: GoogleDistanceMatrix(
